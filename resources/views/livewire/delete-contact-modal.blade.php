<div>
    <flux:modal name="delete-contact" class="md:w-96" wire:model="modalOpen">
        <div class="space-y-6">
            <div>
                <flux:heading size="lg">Potvrdenie zmazania</flux:heading>
                <flux:text class="mt-2">Naozaj chcete odstrániť tento kontakt? Táto akcia je nevratná.</flux:text>
            </div>
